...
class Lteproduct extends CI_Controller
{
	public function __construct()
	{
		parent::__construct();
		$this->load->model('Lteproduct_model');
		$this->load->model('Setting_model');
	}

	public function lteporduct_post()
	{
		if ($this->session->userdata('user_role') == '1') {
			...
			$dataLaptop = $this->Lteproduct_model->get_laptop();
			$x['dataLaptop'] = $dataLaptop;
	...
	public function lteporduct_stock()
	{
		if ($this->session->userdata('user_role') == '1') {
			// Setting
			$dataSetting = $this->Setting_model->setting();
