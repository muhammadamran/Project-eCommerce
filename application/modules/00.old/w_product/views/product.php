                            ...
                            <form action="<?= base_url('w_product/keranjang'); ?>" method="post">
                                <div class="product__info__main">
                                    ...
                                    <div class="box-tocart d-flex">
                                        ...
                                        <input type="number" name="jumlah" id="harga_produk" size="3" onchange="total()" required>
                                        <!-- END HARGA DB -->
                                        ...
                                        <div class="addtocart__actions">
                                            <?php if ($this->session->userdata("role") == NULL) { ?>
                                                ...
                                                <!-- <a data-toggle="modal" title="Sign In" href="#login">
                                                <button class="tocart" type="submit" title="Beli">Beli</button>
                                            </a> -->
                                            <?php } else { ?>
                                    ...
                                    <div class="subtotal">
                                        <!-- HARGA TOTAL JUMLAH -->
                                        <h5>Sub Total </h5>
                                        <h3>Rp. <b><input class="nilai-subtotal" name="harga" type="text" name="total_jumlah" id="totalkeroncange" size="7" value="" readonly></b></h3>
                                        <!-- END HARGA TOTAL JUMLAH -->

                                        <!-- JAVASCRIPT HITUNG BELI -->
                                        <script type="text/javascript">
                                            function total() {
                                                var valuehargap = <?= $row['harga'] ?> * parseInt(document.getElementById('harga_produk').value);
                                                var jumlah_harga = valuehargap;

                                                document.getElementById('totalkeroncange').value = jumlah_harga;
                                            }
                                        </script>
                                        <!-- END JAVASCRIPT HITUNG BELI -->

                                        <br>
                                        <div class="review_form_field">
                                            <!-- <span><b><img src="<?= base_url('mode/images/icons/notes.png'); ?>"> <font style="font-family: 'Poppins', sans-serif; color:#003369">Catatan Jika Ada</font></b> <small><i>(Optional)</i></small></span> -->
                                            <span>
                                                <b>
                                                    <!-- <img src="<?= base_url('mode/images/icons/notes.png'); ?>"> -->
                                                    <font>Catatan Pemesanan</font>
                                                </b>
                                            </span>
                                            <div class="input__box col-8">
                                                <textarea name="catatan" class="form-control" placeholder="Contoh: Ukuran Baju M dst..."></textarea>
                                            </div>
                                        </div>
                                    </div>
