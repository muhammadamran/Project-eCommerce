        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="bradcaump__inner text-center">
                    <h2 class="bradcaump-title">Celana Olahraga</h2>
                    <nav class="bradcaump-content">
                        <a class="breadcrumb_item" href="<?php echo base_url()."w_home"; ?>">Home</a>
                        <span class="brd-separetor">/</span>
                        <span class="breadcrumb_item active">Celana Olahraga</span>
                    </nav>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-3 col-12 order-2 order-lg-1 md-mt-40 sm-mt-40">
                <div class="shop__sidebar">
                    <aside class="wedget__categories poroduct--cat">
                        ...
                        <ul>
                            <li><a href="<?php echo base_url()."w_shop/celana"; ?>">Celana <span>(3)</span></a></li>
                            <li><a href="<?php echo base_url()."w_shop/celana_jeans"; ?>">Celana Jeans <span>(3)</span></a></li>
                            <li><a href="<?php echo base_url()."w_shop/celana_chino"; ?>">Celana Chino <span>(4)</span></a></li>
                            <li><a href="<?php echo base_url()."w_shop/celana_olahraga"; ?>">Celana Olahraga <span>(6)</span></a></li>
                        </ul>
                    </aside>
