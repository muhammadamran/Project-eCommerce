        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="bradcaump__inner text-center">
                    <h2 class="bradcaump-title">Souvenir Name TAG</h2>
                    <nav class="bradcaump-content">
                        <a class="breadcrumb_item" href="<?php echo base_url()."w_home"; ?>">Home</a>
                        <span class="brd-separetor">/</span>
                        <span class="breadcrumb_item active">Souvenir Name TAG</span>
                    </nav>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-3 col-12 order-2 order-lg-1 md-mt-40 sm-mt-40">
                <div class="shop__sidebar">
                    <aside class="wedget__categories poroduct--cat">
                        ...
                        <ul>
                            <li><a href="<?php echo base_url()."w_shop/souve"; ?>">Souvenir <span>(3)</span></a></li>
                            <li><a href="<?php echo base_url()."w_shop/souve_tag"; ?>">Souvenir Name TAG <span>(3)</span></a></li>
                            <li><a href="<?php echo base_url()."w_shop/souve_card"; ?>">Souvenir ID Card <span>(4)</span></a></li>
                        </ul>
                    </aside>
