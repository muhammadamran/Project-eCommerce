...
class Ltesubscribe extends CI_Controller
{
	public function __construct()
	{
		parent::__construct();
		$this->load->model('Ltesubscribe_model');
	...
	public function index()
	{
		if ($this->session->userdata('user_role') == '1') {
			...
			$dataSubscribe = $this->Ltesubscribe_model->subscribe();
			$x['data'] = $dataSubscribe;
