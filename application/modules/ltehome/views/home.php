                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-xl-5 col-lg-4 align-items-center d-flex justify-content-center">
                            <img src="<?= base_url('assets/lte/img/svg/img-1.svg'); ?>" height="150px" class="d-none d-lg-block" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div>
                        <div class="d-flex align-items-center text-white mb-2">
                            <div class="widget-img widget-img-xs rounded bg-inverse mr-2 width-40" style="background-image: url(<?= base_url('assets/lte/img/flag/us.jpg)"></'); ?>div>
                        ...
                        <div class="d-flex align-items-center text-white mb-2">
                            <div class="widget-img widget-img-xs rounded bg-inverse mr-2 width-40" style="background-image: url(<?= base_url('assets/lte/img/flag/cn.jpg)"></'); ?>div>
                            <div class=" d-flex w-100">
                                <div>China</div>
                        ...
                        <div class="d-flex align-items-center text-white mb-2">
                            <div class="widget-img widget-img-xs rounded bg-inverse mr-2 width-40" style="background-image: url(<?= base_url('assets/lte/img/flag/de.jpg)"></'); ?>div>
                            <div class=" d-flex w-100">
                                <div>Germany</div>
                        ...
                        <div class="d-flex align-items-center text-white mb-2">
                            <div class="widget-img widget-img-xs rounded bg-inverse mr-2 width-40" style="background-image: url(<?= base_url('assets/lte/img/flag/fr.jpg)"></'); ?>div>
                            <div class=" d-flex w-100">
                                <div>France</div>
                        ...
                        <div class="d-flex align-items-center text-white mb-0">
                            <div class="widget-img widget-img-xs rounded bg-inverse mr-2 width-40" style="background-image: url(<?= base_url('assets/lte/img/flag/jp.jpg)"></'); ?>div>
                            <div class=" d-flex w-100">
                                <div>Japan</div>
